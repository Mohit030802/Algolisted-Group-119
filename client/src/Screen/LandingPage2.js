...
const LandingPage2 = () => {
  ...
  useEffect(() => {
    axios.get("https://api.github.com/repos/vishwas-kr/Algolisted-Group-119/contributors")
      .then((res) => {
        ...
        <MobileNavbar/>
            ...
            <div className="page2" id='content'>
              <div className="content">
                  ...
                  <Fade>
                    <div className="desc">
                        We are currently divided into 4 Modules, all are helpful for every coder. We have also applied machine
          ...
          <div className="middle">
            <div className="left">
              <div className="left-content">
                ...
                <div className="points">
                  <RouterLink to="organisation-information/contributor-work" className="link">About us</RouterLink>                  
                  <RouterLink to="/" className="link">Team</RouterLink>            
                  <RouterLink to="/" className="link">Our Mission</RouterLink>  
                  <RouterLink to="/" className="link">Contact</RouterLink>  
                  <RouterLink to="/" className="link">Future Vision</RouterLink>                  
                </div>
              </div>
