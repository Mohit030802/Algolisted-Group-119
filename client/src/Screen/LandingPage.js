      ...
      <MobContainer>
        ...
        <Fade>
          <div className="top-page">
            ...
            <div className="small-desc">
              Algolisted is a community-driven platform for learning and
              improving coding skills. It offers a wealth of information on data
              structures and algorithms, and allows coders to interact with,
              modify, and contribute to the content.
            </div>
            <div className="btn">
              <Link
                to="content"
        ...
        <div className="page2" id="content">
          <div className="content">
            <Fade>
              <h1>
                Speed up your Learning and Development with Algolisted today
              </h1>
            </Fade>
            <Fade>
              <div className="desc">
                We are currently divided into 4 Modules, all are helpful for
                every coder. We have also applied machine learning models for
                get info about a company and applications web scraping to get
                you the questions from other website at one place.
              </div>
            </Fade>
          </div>
        ...
        <div className="open-source-page">
          <div className="content">
            ...
            <Fade>
              <div className="desc">
                Our website is a testament to the dedication and contributions
                of our amazing open source community. Every member has put in
                their best efforts to create and improve the site. If you want
                to resolve an issue or suggest a new feature, we encourage you
                to participate in the open source process by creating an issue.
              </div>
            </Fade>
          </div>
          <a
            href="https://github.com/vishwas-kr/Algolisted-Group-119/"
            target={"_blank"}
            className="btn"
          >
            Start Contributing
          ...
          <div className="middle">
            <div className="left">
              <div className="left-content">
                <div className="title">Algolisted</div>
                <div className="points">
                  <RouterLink to="about-us" className="link">
                    About us
                  </RouterLink>
                  <RouterLink to="core-team" className="link">
                    Team
                  </RouterLink>
                  <RouterLink to="mission" className="link">
                    Our Mission
                  </RouterLink>
                  <RouterLink to="contact" className="link">
                    Contact
                  </RouterLink>
                  <RouterLink to="future-vision" className="link">
                    Future Vision
                  </RouterLink>
                </div>
              </div>
              ...
              <div className="left-content">
                ...
                <div className="points">
                  ...
                  <RouterLink to="create-account" className="link">
                    Create account
                  </RouterLink>
                  <RouterLink to="request-api" className="link">
                    Request API access
                  </RouterLink>
                </div>
              </div>
            ...
            <div className="right">
              <h1>Algolisted.</h1>
              <span>Get organized listed information. Get productive.</span>
            </div>
          </div>
      ...
      <Container>
        <Navbar>
          ...
          <div className="menu-list">
            ...
            <button className="btn">
              {isLoggedin ? <a href="/auth" onClick={logout}>Logout</a> : <a href="/auth">Login</a>}
            </button>
          </div>
        </Navbar>
                <ToastContainer/>
        <div className="hero-page">
          <div className="responsive-1700">
            <div className="left">
              ...
              <Fade>
                <div className="small-desc">
                  Discover an AI-powered coding website that combines elegant
                  design with powerful features. Track your progress, access
                  contest insights, and challenge friends in coding
                  competitions.
                </div>
              </Fade>
              <Fade left>
            ...
            <div className="right">
              <Fade>
                <div className="img-container">
                  ...
                  <img
                    src="https://analytics-smart.com/wp-content/uploads/2022/06/Data-Science1-1.gif"
                    alt=""
                  />
        ...
        <div className="page2">
          <div className="content">
            ...
            <Fade bottom>
              <div className="desc">
                We are currently divided into 5 Modules, all are helpful for
                every coder. We have also applied machine learning models for
                get info about a company and applications web scraping to get
                you the questions from other website at one place.
              </div>
        ...
        <div className="open-source-page">
          ...
          <div className="hold-contributors">
            <div className="contributor">
              <img
                src="https://icons-for-free.com/iconfiles/png/512/logo+react+react+js+icon-1320184811840217251.png"
                alt=""
              />
            </div>
            <div className="contributor">
              <img
                src="https://vistaran-tech.s3.ap-south-1.amazonaws.com/wp-content/uploads/2022/05/13104926/nodejs-logo.png"
                alt=""
              />
            </div>
            <div className="contributor">
            ...
            <div className="contributor">
              <img src="https://www.styled-components.com/atom.png" alt="" />
            </div>
            <div className="contributor">
              <img
                src="https://openastronomy.org/pyastro/images/pyastro_logo.svg"
                alt=""
              />
            </div>
            <div className="contributor">
            ...
            <div className="contributor">
              <img src="https://egw2023.eurac.edu/favicon.ico" alt="" />
            </div>
          </div>
...
const Container = styled.div`
  ...
  .open-source-page {
    ...
    .btn {
      ...
      -webkit-animation: AnimationName 10s cubic-bezier(0.25, 0.1, 0, 1.47)
        infinite;
      -moz-animation: AnimationName 10s cubic-bezier(0.25, 0.1, 0, 1.47)
        infinite;
