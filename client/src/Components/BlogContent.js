...
const BlogContent = ({ blogid }) => {
    ...
    return ( <
        ...
        div className = "left" > { /* <ShowContributors /> */ } <
        ...
        iframe height = { blogData.docHeightPx }
        src = { `${blogData.docLinkIframe}` } > < /iframe>
        ...
        div className = "para-1" >
        You can ask any questions or doubts you have about the blog topic in this section.Please note that this section is
        for asking questions and seeking clarification, not
        for making complimentary comments about the blog.If you have a question or doubt, a notification will be sent to the blog creators so they can address it.Please refrain from using this section
        for flattering comments. <
        /div> <
        div className = "message" >
        <
        div className = "text" >
